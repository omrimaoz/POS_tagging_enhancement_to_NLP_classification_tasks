...
import os
import numpy as np
from check_datasets import load_json
...
def train_net(json_path, mode, epoch_num, train_percent, val_percent, file_name):
    ...
    training_args = TrainingArguments("DAN",
                                      # YOUR CODE HERE
                                      num_train_epochs=epoch_num,  # must be at least 10.
    ...
    for subject in subjects:
        for suffix in suffixes:
            for size in sizes:
                ...
                json_path = f'../Datasets/{file_name}'
                train_net(json_path, mode, 50, 0.8, 0, file_name)
